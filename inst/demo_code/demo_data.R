...
#' Demo
#' @param baf BAF values
#' @param baf.fit BAF fitted
#' @importFrom ggplot2 stat_binhex
#' @importFrom ggplot2 ggplot
#' @importFrom ggplot2 aes
.demo <- function(baf, baf.fit){
  data.type <- 'geno'
  data.type <- 'BAF'
  s.idx <- c(1,5)
  prop <- c(0.1, 0.9)
...
#' Title
#' @param data.type Data type, either geno or BAF
#' @param demo Demo data feeded in
#' 
.demoDeconvolution <- function(data.type='baf', demo){
